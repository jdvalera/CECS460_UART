...
reg           memhiolX,memhiolQ;           // indicate space accessed
...
always @(posedge CLK, posedge RESET)
   if (RESET) begin
      ...
      memhiolQ <= 1'b0;                 // mem acc = 1/io acc = 0
      end
  else
      begin
      ...
      memhiolQ <= memhiolX;             // mem acc = 1/io acc = 0
      end
